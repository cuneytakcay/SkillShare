...
Promise.all([...userPromise]).then(() => {
  const needSeeds = [
    ...
    {
      title: 'Bowie Needs a Regular Walk',
      category: 'Pet Care',
    ...
    {
      title: 'Feed My Iguana',
      category: 'Pet Care',
      description: 'Please come by and feed my iguana. Her title is Arizona and she primarily eats cockroaches.',
